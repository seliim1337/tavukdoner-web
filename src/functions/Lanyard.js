...
/**
 *
 * @param {{userId: string|string[], socket?: boolean, onPresenceUpdate: function({})}} opts
 * @returns
 */
export default async function lanyard(opts) {
    ...
    if (opts.socket) {
        ...
        if (socket.CONNECTING) console.log("Connecting to socket...");
